...
INPUT_URL = "https://epgshare01.online/epgshare01/epg_ripper_US2.xml.gz"
...
COUNTRIES_XML_PATH = os.path.join("countries", "US.epg.xml")

# 3) Channel ID to read from the input EPG
CHANNEL_ID_TO_READ = "CNN.International.us2"

# 4) Output file path for the per-channel EPG under channels subfolder
OUTPUT_CHANNEL_XML_PATH = os.path.join("channels", "CNN-International.xml")

# 5) Optional override Channel Name (if None, read from source EPG)
OUTPUT_CHANNEL_NAME = "CNN International"

# 6) Optional override Channel ID (if None, keep as source channel id)
OUTPUT_CHANNEL_ID = "CNN.International.us"

# 7) Optional override Channel Logo URL (if None, read from source EPG)
OUTPUT_CHANNEL_LOGO = "https://thefilmtuition.com/tvlogo/CNN-International.png"
...
def main():
    debug("Starting CNN International EPG generation script")
