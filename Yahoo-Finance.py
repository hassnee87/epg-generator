...
INPUT_URL = "https://i.mjh.nz/Plex/us.xml.gz"
...
COUNTRIES_XML_PATH = os.path.join("countries", "US-Plex.epg.xml")

# 3) Channel ID to read from the input EPG
CHANNEL_ID_TO_READ = "5e20b730f2f8d5003d739db7-5f170f01b898490041b49dd1"

# 4) Output file path for the per-channel EPG under channels subfolder
OUTPUT_CHANNEL_XML_PATH = os.path.join("channels", "Yahoo-Finance.xml")

# 5) Optional override Channel Name (if None, read from source EPG)
OUTPUT_CHANNEL_NAME = "Yahoo Finance"

# 6) Optional override Channel ID (if None, keep as source channel id)
OUTPUT_CHANNEL_ID = "Yahoo.Finance.us"

# 7) Optional override Channel Logo URL (if None, read from source EPG)
OUTPUT_CHANNEL_LOGO = "https://thefilmtuition.com/tvlogo/Yahoo-Finance.png"  
...
def main():
    debug("Starting Yahoo Finance EPG generation script")
