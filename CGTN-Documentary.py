...
INPUT_URL = "https://epgshare01.online/epgshare01/epg_ripper_AU1.xml.gz"
...
COUNTRIES_XML_PATH = os.path.join("countries", "AU.epg.xml")

# 3) Channel ID to read from the input EPG
CHANNEL_ID_TO_READ = "CGTNDocumentary.au"

# 4) Output file path for the per-channel EPG under channels subfolder
OUTPUT_CHANNEL_XML_PATH = os.path.join("channels", "CGTN-Documentary.xml")

# 5) Optional override Channel Name (if None, read from source EPG)
OUTPUT_CHANNEL_NAME = "CGTN Documentary"

# 6) Optional override Channel ID (if None, keep as source channel id)
OUTPUT_CHANNEL_ID = "CGTN.Documentary.cn"

# 7) Optional override Channel Logo URL (if None, read from source EPG)
OUTPUT_CHANNEL_LOGO = "https://thefilmtuition.com/tvlogo/CGTN-Documentary.png"
...
def main():
    debug("Starting CGTN Documentary EPG generation script")
