...
INPUT_URL = "https://i.mjh.nz/PlutoTV/us.xml.gz"
...
COUNTRIES_XML_PATH = os.path.join("countries", "US-Pluto.epg.xml")

# 3) Channel ID to read from the input EPG
CHANNEL_ID_TO_READ = "66e0b4536ad04d0008fff4b2"

# 4) Output file path for the per-channel EPG under channels subfolder
OUTPUT_CHANNEL_XML_PATH = os.path.join("channels", "CNN-Originals.xml")

# 5) Optional override Channel Name (if None, read from source EPG)
OUTPUT_CHANNEL_NAME = "CNN Originals"

# 6) Optional override Channel ID (if None, keep as source channel id)
OUTPUT_CHANNEL_ID = "CNN.Originals.us"

# 7) Optional override Channel Logo URL (if None, read from source EPG)
OUTPUT_CHANNEL_LOGO = "https://thefilmtuition.com/tvlogo/CNN-Originals.png"
...
def main():
    debug("Starting CNN Originals EPG generation script")
