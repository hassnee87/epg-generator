...
INPUT_URL = "https://raw.githubusercontent.com/BuddyChewChew/tubi-scraper/refs/heads/main/tubi_epg.xml"
...
def main():
    debug("Starting ABC News Live EPG generation script")
