...
INPUT_URL = "https://i.mjh.nz/SamsungTVPlus/us.xml.gz"
...
COUNTRIES_XML_PATH = os.path.join("countries", "US-Samsung.epg.xml")

# 3) Channel ID to read from the input EPG
CHANNEL_ID_TO_READ = "USAJ30000041W"

# 4) Output file path for the per-channel EPG under channels subfolder
OUTPUT_CHANNEL_XML_PATH = os.path.join("channels", "Bloomberg-Originals.xml")

# 5) Optional override Channel Name (if None, read from source EPG)
OUTPUT_CHANNEL_NAME = "Bloomberg Originals"

# 6) Optional override Channel ID (if None, keep as source channel id)
OUTPUT_CHANNEL_ID = "Bloomberg.Originals.us"

# 7) Optional override Channel Logo URL (if None, read from source EPG)
OUTPUT_CHANNEL_LOGO = "https://thefilmtuition.com/tvlogo/Bloomberg-Originals.png"
...
def main():
    debug("Starting Bloomberg Originals EPG generation script")
