...
INPUT_REMOTE = "https://thefilmtuition.com/epg/pk/PTV/PTVHome.Schedule.All.txt"
INPUT_LOCAL = "PTVHome.Schedule.All.txt"
CHANNEL_ID = "PTV.Home.pk"
CHANNEL_NAME = "PTV Home"
CHANNEL_LOGO = "https://thefilmtuition.com/tvlogo/PTV-Home.png"
OUTPUT_CHANNELS = os.path.join("channels", "PTV-Home.xml")
OUTPUT_PKCHANNELS = os.path.join("pkchannels", "PTV-Home.xml")
...
def main():
    ...
    print(f"[INFO] PTV Home EPG written to {OUTPUT_CHANNELS} and {OUTPUT_PKCHANNELS}")
