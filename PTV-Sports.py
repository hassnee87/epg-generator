...
INPUT_REMOTE = "https://thefilmtuition.com/epg/pk/PTV/PTVSports.Schedule.All.txt"
INPUT_LOCAL = "PTVSports.Schedule.All.txt"
CHANNEL_ID = "PTV.Sports.pk"
CHANNEL_NAME = "PTV Sports"
CHANNEL_LOGO = "https://thefilmtuition.com/tvlogo/PTV-Sports.png"
OUTPUT_CHANNELS = os.path.join("channels", "PTV-Sports.xml")
OUTPUT_PKCHANNELS = os.path.join("pkchannels", "PTV-Sports.xml")
...
def main():
    ...
    print(f"[INFO] PTV Sports EPG written to {OUTPUT_CHANNELS} and {OUTPUT_PKCHANNELS}")
