...
INPUT_REMOTE = "https://thefilmtuition.com/epg/pk/PTV/PTVNational.Schedule.All.txt"
INPUT_LOCAL = "PTVNational.Schedule.All.txt"
CHANNEL_ID = "PTV.National.pk"
CHANNEL_NAME = "PTV National"
CHANNEL_LOGO = "https://thefilmtuition.com/tvlogo/PTV-National.png"
OUTPUT_CHANNELS = os.path.join("channels", "PTV-National.xml")
OUTPUT_PKCHANNELS = os.path.join("pkchannels", "PTV-National.xml")
...
def main():
    ...
    print(f"[INFO] PTV National EPG written to {OUTPUT_CHANNELS} and {OUTPUT_PKCHANNELS}")
